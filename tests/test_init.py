...
async def test_the_entity_surface(
    ...
    assert ids == {
        ...
        "binary_sensor.office_wall_display_connected",
        ...
        "sensor.office_wall_browser_crashes",
        "sensor.office_wall_cpu_frequency",
        "sensor.office_wall_core_voltage",
        ...
        "sensor.office_wall_ssid",
        "sensor.office_wall_monitor",
