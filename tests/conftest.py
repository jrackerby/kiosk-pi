...
DEVICE_INFO: dict[str, Any] = {
    ...
    "browserCrashCount": 0,
    "browserCommandedRestartCount": 2,
    "browserWatchdogRestartCount": 0,
    "browserLastExitCode": 0,
    "browserLastExitReason": "commanded",
    "browserResponsive": True,
    "browserHangSeconds": 120,
    ...
    "displayConnectors": [{"name": "HDMI-A-1", "status": "connected"},
